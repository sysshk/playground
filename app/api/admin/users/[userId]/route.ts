...
/** 권한 변경. 역할이 섞여 기록이 엉키는 경우는 먼저 정리하도록 막는다. */
export async function PATCH(request: Request, { params }: Params) {
  ...
  try {
    ...
    // 내 권한을 스스로 내리면 관리자가 한 명도 없게 될 수 있다.
    if (userId === trainerId) {
