...
const SLOTS: [number, Line[]][] = [
  [22, [
    ...
    (n) => `푹 쉬고 내일 봬요, ${n} 님`,
    (n) => `오늘 수업 기록은 다 남기셨나요, ${n} 님?`,
    (n) => `스트레칭 한 번 하고 주무세요, ${n} 님`,
    (n) => `오늘도 회원들 잘 챙기셨어요, ${n} 님`,
    (n) => `내일 예약도 한번 훑어볼까요, ${n} 님?`,
  ]],
  [18, [
    (n) => `오늘도 수고하셨어요, ${n} 님`,
    (n) => `저녁 수업까지 힘내세요, ${n} 님`,
  ...
  [11, [
    ...
    (n) => `단백질 챙겨 드셨나요, ${n} 님?`,
    (n) => `점심 먹고 가볍게 걸어 볼까요, ${n} 님?`,
    (n) => `오전 수업 기록은 남기셨나요, ${n} 님?`,
  ]],
  [5, [
    (n) => `좋은 아침이에요, ${n} 님`,
    (n) => `오늘 첫 수업도 힘차게, ${n} 님`,
    (n) => `상쾌하게 하루 시작해요, ${n} 님`,
    (n) => `오늘 예약된 수업부터 볼까요, ${n} 님?`,
    (n) => `커피 한 잔과 함께 시작해요, ${n} 님`,
    (n) => `오늘도 좋은 기록 남겨 봐요, ${n} 님`,
